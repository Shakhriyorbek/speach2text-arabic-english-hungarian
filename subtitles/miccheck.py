...
def test(device, seconds):
    ...
    if all_zero:
        ...
        print("  rather than an error. Press Win+I, then:")
        print()
        print("    Windows 10:  Privacy  ->  Microphone")
        print("                 Confidentialite  ->  Microphone")
        print("    Windows 11:  Privacy & security  ->  Microphone")
        print("                 Confidentialite et securite  ->  Microphone")
        print()
        print("  Turn ON all three. The third is the one that matters here:")
        print("    1. Microphone access for this device / Acces au microphone")
        print("       (Windows 10 hides this behind a 'Change'/'Modifier' button)")
        print("    2. Let apps access your microphone")
        print("       Autoriser les applications a acceder a votre microphone")
        print("    3. LET DESKTOP APPS ACCESS YOUR MICROPHONE")
        print("       Autoriser les applications de bureau a acceder au microphone")
        print()
        print("  Number 3 governs THIS program and is separate from number 2,")
        print("  which governs Store apps like Voice Recorder. ON WINDOWS 10 IT")
        print("  IS AT THE VERY BOTTOM of that page, below a long list of apps")
        print("  you have to scroll past — which is why it gets missed.")
        print()
